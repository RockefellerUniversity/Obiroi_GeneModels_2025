...
## Create Subread index for reference genome (Rhisat2)
...
```
```
Warning: running command 'pbmm2 index /lustre/fs4/brc/scratch/brc_pipeline/reference/BRCDK_long/workflow_data/BRCDK_long_BzippedWhite.fa.bgz BRCDK_long_pbmm2index.mmi' had status 1

Warning: running command 'pbmm2 index /lustre/fs4/brc/scratch/brc_pipeline/reference/BRCDK_long/workflow_data/BRCDK_long_BzippedWhite.fa.bgz /lustre/fs4/brc/scratch/brc_pipeline/reference/BRCDK_long/workflow_data/BRCDK_long_pbmm2index.mmi' had status 1
...
To assign RNAseq reads to genes we can use the featureCounts function within the Rsubread package.

We have to provide our GTF file as our gene models to count over.
...
Warning: running command 'gffcompare -r /tmp/RtmptUeirw/BRCDK_long_gBzipped.gtf -o /rugpfs/fs0/brc/scratch/brc_pipeline/analysis/kip_redo/Kip_Long_BothBatches/workflow_data/Sample1_gffcompare.gtf /tmp/RtmptUeirw/merged_pigeon_transdecode.gtf.gz' had status 1

Warning: running command 'gffcompare -r /tmp/Rtmp9j5IQT/BRCDK_long_gBzipped.gtf -o /rugpfs/fs0/brc/scratch/brc_pipeline/analysis/kip_redo/Kip_Long_BothBatches/workflow_data/Sample1_gffcompare.gtf /tmp/Rtmp9j5IQT/merged_pigeon_transdecode.gtf.gz' had status 1
